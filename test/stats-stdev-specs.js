...
describe( 'stats-stdv normal behaviour', function () {
...
describe( 'stats-varianceXn error behaviour', function () {
  it( 'should throw error with wrong data-type or empty array', function () {
    expect( () => stdev( 3 ) ).to.throw( 'stats-variance: x should be an array of length > 0, instead found' );
    expect( () => stdev( [] ) ).to.throw( 'stats-variance: x should be an array of length > 0, instead found' );
